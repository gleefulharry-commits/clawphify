...
def _rebuild_code(watch_path: Path, *, follow_symlinks: bool = False) -> bool:
    ...
    """
    try:
        from clawphify.extract import collect_files, extract
        from clawphify.build import build_from_json
        from clawphify.cluster import cluster, score_all
        from clawphify.analyze import god_nodes, surprising_connections, suggest_questions
        from clawphify.report import generate
        from clawphify.export import to_json
